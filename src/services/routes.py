...
from services.viewsets.dashboard import DashboardViewsets, DashboardTableViewsets
...
router.register('dashboard/tables', DashboardTableViewsets, basename='dashboard-tables-viewsets')
